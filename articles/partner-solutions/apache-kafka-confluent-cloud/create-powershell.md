...
1. On the **Marketplace** page, choose from two billing options:
   ...
   For **commitment plans**, select the **View private plans** link. The commitment requires you to sign up for a minimum spend amount. Use this option only when you know you need to use the service for an extended time.
   ...
   :::image type="content" source="media/select-from-private-offers.png" alt-text="Screenshot that shows the option to select a private plan." lightboxe="media/select-from-private-offers.png":::
