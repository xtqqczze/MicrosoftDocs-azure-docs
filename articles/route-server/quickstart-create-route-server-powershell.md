...
1. Configure Route Server's capacity using the [New-AzVirtualRouterAutoScaleConfiguration](/powershell/module/az.network/new-azvirtualrouterautoscaleconfiguration) cmdlet. or more information, see [Route Server Capacity](/azure/route-server/route-server-capacity.md).
     ```azurepowershell-interactive
