...
> The service is designed to collect data from all services. This behavior can't be customized.
> Data collection rule (DCR) transformations also aren't supported for Change Tracking DCRs.
