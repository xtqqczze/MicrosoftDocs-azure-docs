...
- To migrate from Azure CTI by using Azure Monitor Logs to the Azure Monitor agent, see [Migration guidance for Azure CTI](../automation/troubleshoot/change-tracking.md).
