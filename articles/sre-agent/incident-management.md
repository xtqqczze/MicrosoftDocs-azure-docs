...
Minimal setup is required for Azure Monitor (default integration). Non-Microsoft systems like PagerDuty and ServiceNow require extra setup for incident handling preferences. All platforms automatically handle SEV2 and lower issues by default. You can change this default behavior at any time.
