...
> [!NOTE]
> Using the script to migrate developer portal content between an API Management instance in a classic tier (for example, Standard) and an instance in a v3 tier (for example, Standard v3) isn't currently supported. Migration of portal content between instances in the v3 tiers is also not supported.
