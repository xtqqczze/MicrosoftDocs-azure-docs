...
No. Certificate Management is an optional feature of ADR, and thus it requires using ADR to manage device certificates. You must set up an ADR namespace and link it to your IoT Hub Gen 2 and DPS instance to use Certificate Management. For more information, see [What is Certificate Management?](iot-hub-certificate-management-overview.md) and [Set up Azure Device Registry](iot-hub-device-registry-setup.md).

## What is the pricing model for IoT Hub Gen 2?

During the preview period, IoT Hub Gen 2 is **free to use**. After the preview period, pricing details will be provided.
