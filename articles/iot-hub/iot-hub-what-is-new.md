...
From November 2025, IoT Hub introduces two new features: integration with Azure Device Registry (ADR) and enhanced certificate management. These features are designed to improve security, simplify device management, and streamline operations for IoT deployments.
...
IoT Hub now introduces certificate management for managing device certificates using Microsoft-managed public key infrastructure (PKI) with X.509 certificates.
