...
Azure NetApp Files also supports breakthrough mode for large volumes, offering increased throughput for demanding workloads. With cool access enabled, volumes can scale to 7.2 PiB. 
