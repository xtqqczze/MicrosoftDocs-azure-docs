...
> [!IMPORTANT]
> Forced tunnel is available for Azure Firewall deployments in the Virtual WAN hub (secured Virtual hub) that utilize routing intent. See [internet access patterns in Virtual WAN](about-internet-routing.md) for more information.  
