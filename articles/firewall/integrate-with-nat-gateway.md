...
> [!NOTE]
> Deploying NAT gateway with a zone redundant firewall isn't a recommended deployment option, as Standard NAT gateway doesn't support zonal redundant deployments. StandardV2 NAT Gateway does support zone-redundant deployments and is in public preview. For more information, see [NAT Gateway SKUs](nat-sku.md).
