...
1. In the Microsoft Entra admin center, under **Manage**, select **Enterprise applications**. Confirm that the Dev Tunnels service appears in the list of registered applications.
