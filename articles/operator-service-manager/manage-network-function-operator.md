...
# Manage the NFO extension

This article guides user management of the Azure Operator Service Manager network function operator (NFO) extension. This kubernetes cluster extension is used as part of the Azure Operator Service Manager service offering and used to manage container based workloads, hosted by the Azure Operator Nexus platform.
...
> [!NOTE]
>
> * When managing a NAKS cluster with Azure Operator Service Manager, the default parameter values enable HA as the recommended configuration.
> * When managing a AKS cluster with Azure Operator Service Manager, HA must be disabled using the following configuration options:
>
>```
