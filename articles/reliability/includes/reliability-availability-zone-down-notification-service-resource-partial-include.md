---
title: Azure availability zones - zone-down notifications (Service Health + Resource Health)
description: Include file for the zone-down behavior section's *Notification* bullet that describes how Service Health and Resource Health can be used.
author: anaharris-ms
ms.service: azure
ms.topic: include
ms.date: 11/04/2025
...
Microsoft doesn't automatically notify you when a zone is down. However:
