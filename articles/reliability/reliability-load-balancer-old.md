...
Azure Load Balancer is a layer-4 (TCP/UDP) load balancer that distributes traffic across backend instances within a virtual network and provides outbound connectivity with SNAT. 
