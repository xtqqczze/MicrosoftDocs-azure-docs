...
Fabric uses Azure availability zones to protect Fabric and Power BI items and data from datacenter failures. Fabric makes commercially reasonable efforts to support zone-redundant availability zones, where resources automatically replicate across zones, without any need for you to set up or configure. 
