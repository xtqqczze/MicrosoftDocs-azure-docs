...
To learn how to redeploy a regional scale set to availability zone support, see [Update scale set to add availability zones](/virtual-machine-scale-sets/virtual-machine-scale-sets-use-availability-zones#update-scale-set-to-add-availability-zones).
