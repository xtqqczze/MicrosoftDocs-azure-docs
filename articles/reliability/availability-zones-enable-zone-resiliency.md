...
| [Azure Service Fabric managed cluster](/azure/service-fabric/how-to-managed-cluster-availability-zones) | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | :::image type="content" source="media/icon-checkmark.svg" alt-text="Yes" border="false"::: | Redeployment | Minimum VM count required |
