...
More information about the announcement on the end of life of SAP's on-premises Identity Management solutions and [migration to Microsoft Entra](https://learn.microsoft.com/en-us/entra/id-governance/scenarios/migrate-from-sap-idm)
