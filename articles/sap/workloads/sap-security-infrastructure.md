...
#### Azure Bastion 
System Administrator’s workstations can be infected with Malware such as Key loggers. Azure Bastion is generally recommended [Azure Bastion documentation | Microsoft Learn](/azure/bastion/)
