...
|Benchmark Title|
|---|
|[CIS Red Hat Enterprise Linux 9 Benchmark 2.0.0 Level 2 - Server](#cis-red-hat-enterprise-linux-9-benchmark-200-level-2---server)|

## CIS Red Hat Enterprise Linux 9 Benchmark 2.0.0 Level 2 - Server
