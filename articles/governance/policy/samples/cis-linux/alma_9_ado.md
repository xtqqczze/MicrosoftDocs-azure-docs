# Release Notes - alma_9_ado

**Supported Benchmarks**
| Benchmark Title |
| --- |
| [CIS AlmaLinux OS 9 Benchmark 2.0.0 Level 1 + 2 Server Profiles](#cis-almalinux-os-9-benchmark-200-level-1-2-server-profiles) |

## CIS AlmaLinux OS 9 Benchmark 2.0.0 Level 1 + 2 Server Profiles
<a id="cis-almalinux-os-9-benchmark-200-level-1-2-server-profiles"></a>
