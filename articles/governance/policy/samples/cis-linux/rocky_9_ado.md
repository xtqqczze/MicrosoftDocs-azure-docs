---
title: Reference - Release Notes - CIS Benchmark - Rocky Linux 9
description: Details of Release Notes - CIS Benchmark - Rocky Linux 9
ms.date: 11/05/2025
author: pallakatos
...
ms.custom: generated
---
# Release Notes - CIS Benchmark - Rocky Linux 9

**Supported Benchmarks**
| Benchmark Title |
| --- |
| [CIS Rocky Linux 9 Benchmark 2.0.0 Level 1 + 2 Server Profiles](#cis-rocky-linux-9-benchmark-200-level-1--2-server-profiles) |

## CIS Rocky Linux 9 Benchmark 2.0.0 Level 1 + 2 Server Profiles
<a id="cis-rocky-linux-9-benchmark-200-level-1--2-server-profiles"></a>
