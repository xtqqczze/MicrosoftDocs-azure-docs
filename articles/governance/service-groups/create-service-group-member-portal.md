...
5. All members to be added will be dislayed in the list. 
...
4. Select the desired Service Group. 
5. In the left hand side service menu, select **members** under relationship management. 
6. Select the members from the list of members by clicking the check box and press **Delete** from the top action bar. This will remove the resource as a member but will not delete the resource. 
