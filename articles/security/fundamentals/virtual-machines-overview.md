...
[Trusted launch](https://learn.microsoft.com/azure/virtual-machines/trusted-launch) is the default for newly created Generation 2 Azure VMs and Virtual Machine Scale Sets. Trusted launch protects against advanced and persistent attack techniques including boot kits, rootkits, and kernel-level malware.
...
Trusted launch can be enabled on existing VMs and Virtual Machine Scale Sets. For more information, see [Trusted launch for Azure virtual machines](https://learn.microsoft.com/azure/virtual-machines/trusted-launch).

## Confidential computing

[Azure confidential computing](https://learn.microsoft.com/azure/confidential-computing/overview) protects data while in use through hardware-based trusted execution environments. Confidential VMs use AMD SEV-SNP technology to create a hardware-enforced boundary between your application and the virtualization stack.
...
For more information, see [Azure confidential VMs](https://learn.microsoft.com/azure/confidential-computing/confidential-vm-overview).

## Azure Backup

[Azure Backup](https://learn.microsoft.com/azure/backup/backup-overview) is a scalable solution that protects your application data with zero capital investment and minimal operating costs. Application errors can corrupt your data, and human errors can introduce bugs into your applications. With Azure Backup, your virtual machines running Windows and Linux are protected.
...
For more information, see [What is Azure Backup?](https://learn.microsoft.com/azure/backup/backup-overview) and [Azure Backup service FAQ](https://learn.microsoft.com/azure/backup/backup-azure-backup-faq).

## Azure Site Recovery

[Azure Site Recovery](https://learn.microsoft.com/azure/site-recovery/site-recovery-overview) helps orchestrate replication, failover, and recovery of workloads and apps so they're available from a secondary location if your primary location goes down.
...
For more information, see [What is Azure Site Recovery?](https://learn.microsoft.com/azure/site-recovery/site-recovery-overview), [How does Azure Site Recovery work?](https://learn.microsoft.com/azure/site-recovery/azure-to-azure-architecture), and [What workloads are protected by Azure Site Recovery?](https://learn.microsoft.com/azure/site-recovery/site-recovery-workload).
...
For more information, see [Azure network security overview](https://learn.microsoft.com/azure/security/fundamentals/network-overview) and [Virtual Network overview](https://learn.microsoft.com/azure/virtual-network/virtual-networks-overview).
...
For more information, see [Introduction to Microsoft Defender for Cloud](https://learn.microsoft.com/azure/defender-for-cloud/defender-for-cloud-introduction), [Microsoft Defender for Servers](https://learn.microsoft.com/azure/defender-for-cloud/defender-for-servers-introduction), and [Microsoft Defender for Cloud frequently asked questions](https://learn.microsoft.com/azure/defender-for-cloud/faq-general).
...
For more information, see [Microsoft Trust Center: Compliance](https://www.microsoft.com/trust-center/compliance/compliance-overview) and [Azure compliance documentation](https://learn.microsoft.com/azure/compliance/).

## Hardware security module

[Azure Key Vault](https://learn.microsoft.com/azure/key-vault/general/overview) provides secure storage for keys and secrets. Key Vault offers the option to store your keys in hardware security modules (HSMs) certified to FIPS 140 validated standards.

Your SQL Server encryption keys for backup or transparent data encryption can all be stored in Key Vault with any keys or secrets from your applications. Permissions and access to these protected items are managed through [Microsoft Entra ID](https://learn.microsoft.com/entra/fundamentals/whatis).

For more information about Azure key management, see [Key management in Azure](https://learn.microsoft.com/azure/security/fundamentals/key-management).

## Next steps

Learn about [security best practices](https://learn.microsoft.com/azure/security/fundamentals/iaas) for VMs and operating systems.
