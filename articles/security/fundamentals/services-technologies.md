...
|Service|Description|
|------|--------|
| [Azure&nbsp;role-based&nbsp;access control](/azure/role-based-access-control/role-assignments-portal)|An access control feature designed to allow users to access only the resources they are required to access based on their roles within the organization.  |
