...
Oracle Database@Azure doesn't support cloud service providers (CSPs), or Outsourcer Channel Agreements (OCAs). However, Oracle Database@Azure supports Multi-party private offers. Multi-party private offers are supported in US, UK and Canada. For more information on MPO, please refer the [Azure Marketplace documentation](/partner-center/marketplace-offers/multiparty-private-offers-for-channel-partners).
