...
19. HCX RAV and Bulk migrations on Gen 2 can experience significantly slower performance due to stalls during Base Sync and Online Sync phases. Customers should plan for longer migration windows and schedule waves accordingly while ongoing engineering work continuees. For suitable workloads, vMotion offers a faster, low‑overhead option when host and network conditions allow
