...
For more frequently asked questions about Connection Monitor, see [Connection Monitor FAQ](../network-watcher/connection-monitor-overview.md#frequently-asked-questions).
