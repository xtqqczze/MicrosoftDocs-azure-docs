...
1. When prompted, provide the following connection information for your integration account:
   ...
   :::image type="content" source="./media/logic-apps-enterprise-integration-x12/create-x12-encode-connection-standard.png" alt-text="Screenshot shows a workflow with connection information for an action named Encode to X12 message by agreement name.":::
...
1. In the X12 action information box, provide the following values:
   ...
   :::image type="content" source="./media/logic-apps-enterprise-integration-x12/encode-x12-message-agreement-standard.png" alt-text="Screenshot shows an action named Encode to X12 message by agreement name with parameters specified.":::
...
1. When prompted, provide the following connection information for your integration account:
   ...
   :::image type="content" source="./media/logic-apps-enterprise-integration-x12/create-x12-decode-connection-standard.png" alt-text="Screenshot shows a workflow with connection information for an action named Decode X12 message.":::
...
1. In the X12 action information box, provide the following values:
   ...
   :::image type="content" source="./media/logic-apps-enterprise-integration-x12/decode-x12-message-standard.png" alt-text="Screenshot shows an action named Decode X12 message with parameters specified.":::
