...
Customer may input an email address in Partner Notification Contact of a partner user who doesn't have permissions on VLC to accept the CoCP. The Azure Portal displays a warning but will allow the user to proceed.
...
A message is displayed to indicate the CoCP has been successfully submitted. Make sure that the partner accepts the request within 10 days.
