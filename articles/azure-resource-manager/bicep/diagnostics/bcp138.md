...
The following example has a for loop inside the disks property of an object literal. Bicep does not allow for-expressions in this context.
...
The solution is to move the for-expression into its own variable and then reference that variable inside the object:
