...
> [!IMPORTANT]
> The Salesforce V1 connector is at [removal stage](connector-release-stages-and-timelines.md). You are recommended to [upgrade the Salesforce connector](connector-salesforce.md#upgrade-the-salesforce-linked-service) from V1 to V2.
