...
1. **User permission**. The user who creates the Azure-SSIS IR must have the [role assignment](/articles/role-based-access-control/role-assignments-list-portal#list-role-assignments-for-a-user-at-a-scope) at least on Azure Data Factory resource with one of the options below:
