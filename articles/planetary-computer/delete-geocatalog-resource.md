...
> [!NOTE]
> Due to the ongoing global [Azure Front Door issues](https://azure.status.microsoft/status/history/?trackingId=YKYN-BWZ), users can expect deletions to take up to 2 hours.
