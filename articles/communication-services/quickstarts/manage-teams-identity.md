...
If you want to check roles in Azure portal, see [List Azure role assignments](../../role-based-access-control//azure/role-based-access-control/role-assignments-list-portal).
