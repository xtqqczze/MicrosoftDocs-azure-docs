...
1. In **Storage Settings**:
    ...
    :::image type="content" source="./media/tutorial-assess-vmware-azure-vmware-solution/vmware-deduplication-compression.png" alt-text="Screenshot of page showing vCenter UI get deduplication and compression reference." lightbox="./media/tutorial-assess-vmware-azure-vmware-solution/vmware-dedupe-compression-ui.png" :::
