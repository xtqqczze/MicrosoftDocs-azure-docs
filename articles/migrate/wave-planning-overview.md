...
| --------- | --------------- | ----------------- | ---------- |
| 1         | Not Started     | The execution hasn't started for this wave and there are more than **N** days for it. | Complete the planning activities and be ready for the execution.   |
...
| 3         | On Track        | The execution is in progress and there are more than **N** days to complete them     |   Keep going   |
