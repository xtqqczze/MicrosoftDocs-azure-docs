...
1. On the migration path tab, you can review the application level details. for migration strategy, TCO for the applicatio and readiness breakup. For each application you can review the readiness coverage, Targets, number of sources and mapped number of targets and the migration strategy.  
