...
1. In the **File type** drop-down, choose **VMware inventory (RVTools XLSX)**.
    ...
    :::image type="content" source="./media/tutorial-discover-vmware/rvtools-drop-down.png" alt-text="Screenshot that shows file type drop-down and to choose RVTools XLSX." lightbox="./media/tutorial-discover-vmware/rvtools-drop-down.png":::
