...
:::image type="content" source="./media/nat-overview/ZR-V2-NATGW.png" alt-text="Figure shows a StandardV2 NAT Gateway spanning multiple availability zones in a region." lightbox="./media/nat-overview/ZR-V2-NATGW.png":::
...
:::image type="content" source="./media/nat-overview/Zonal-V1-NATGW.png" alt-text="Figure shows a Standard NAT Gateway in a single availability zone." lightbox="./media/nat-overview/Zonal-V1-NATGW.png":::
