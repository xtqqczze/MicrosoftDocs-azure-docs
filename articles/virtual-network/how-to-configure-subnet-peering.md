...
1. **Hard limitation**: If you are planning to use the feature in production, **you must be use Intel based V5 SKUs/migrate to V5 SKUs (Intel based 5th generation of VM SKUs, or AMD Genoa or Cobalt 100 based SKUs)** to avoid possible outage due to a bug seen on older gen SKUs.
