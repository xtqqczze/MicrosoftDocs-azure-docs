...
| [Routing preference Internet](routing-preference-overview.md)| Standard: Supported for use with [specific resource types](routing-preference-overview#supported-services) for more granular control on how traffic is routed between Azure and the Internet.<br>Standardv2: Not supported| Not supported.| 
