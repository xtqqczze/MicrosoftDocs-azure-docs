...
| v2 NAT Gateway | You can use a v2 public IP from a prefix for your v2 NAT gateway | To associate an IP from a prefix to your v2 NAT gateway:</br> 1. [Create a v2 prefix.](manage-public-ip-address-prefix.md)</br> 2. [Create a v2 IP from the prefix.](manage-public-ip-address-prefix.md)</br> 3. When you deploy the [v2 NAT Gateway](../nat-gateway/quickstart-create-nat-gateway-v2.md), be sure to select the v2 IP you previously gave from the prefix.|
