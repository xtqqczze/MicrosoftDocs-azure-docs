---
title: Azure Functions Durable Task Scheduler action throughput for Durable Functions (preview)
...
# Azure Functions Durable Task Scheduler action throughput (preview)
