...
description: "Learn how to use the Azure Developer CLI (azd) to create and deploy a Python function app with OpenTelemetry distributed tracing to a Flex Consumption plan on Azure."
ms.date: 10/8/2025
ms.topic: quickstart
ms.custom:
  - ignite-2024
#Customer intent: As a developer, I need to know how to use the Azure Developer CLI to create and deploy my function code with OpenTelemetry distributed tracing to a new function app in the Flex Consumption plan in Azure.
---
...
This demonstrates end-to-end distributed tracing across multiple Azure Functions with OpenTelemetry integration, providing complete visibility into your application's behavior and performance.
