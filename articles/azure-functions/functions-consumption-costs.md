...
To better understand the costs of your functions, you can use Azure Monitor to view cost-related metrics currently being generated by your function apps. You can view metrics using one of these tools:

[!INCLUDE [functions-monitor-metrics-flex-consumption](../../includes/functions-monitor-metrics-flex-consumption.md)]
