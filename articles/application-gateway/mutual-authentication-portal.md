...
## Configure mutual authentication stric mode
...
To configure an existing Application Gateway with mutual authentication passthrough mode, you'll need to first go to the **SSL settings** tab in the Portal and create a new SSL profile. When you create an SSL profile, you'll see two tabs: **Client Authentication** and **SSL Policy**. You have to chose **Client Authentication** to setup passthrough mode.  **SSL Policy** is optional

> [!IMPORTANT]
> For passtrhough mode  you do not need  to upload CA certificate
...
8. Select **Add** to save.
    > [!div class="mx-imgBorder"]
    > ![Add client authentication to SSL profile](./media/mutual-authentication-portal/mutual-authentication-portal.pngTBD)
