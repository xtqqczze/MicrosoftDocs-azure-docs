...
* Use of CycleCloud Marketplace Image 8.8.1
    * Removal of all NVMe and Pyxis-related cluster-init scripts
* Microsoft Entra ID sigle sign-on
    ...
    * Utility script for updating an existing application registration following a sucessful CCW deployment
* Open OnDemand
