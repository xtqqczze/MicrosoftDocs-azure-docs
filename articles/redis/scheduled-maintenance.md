...
Use Scheduled Maintenance to define specific time windows when maintenance activities can occur on your Redis instances. You control when Redis server updates and operating system patches are applied, minimizing unexpected disruptions to your applications.
...
- At least 2 windows per week required
...
Scheduled maintenance windows control specific types of updates while excluding others. Having included and excluded updates create a clear boundary of what activities respect your configured timing.
...
- Critical security patches (may occur outside windows for security compliance)
- Major Redis version upgrades (separately managed with 90-day deferral options)

## Maintenance impact and behavior
...
- Redis instances remain available but may experience connection blips
...
### Default behavior
When no custom maintenance windows are configured, Azure applies updates during nighttime hours in the region where your Redis instance is deployed. This default approach attempts to minimize impact during typical low-usage periods.

## Monitoring and visibility

Azure provides multiple ways to track maintenance activities and their impact on your Redis instances.
...
- [Best practices for Azure Cache for Redis](cache-best-practices.md)
- [Connection resilience best practices](cache-best-practices-connection.md)
