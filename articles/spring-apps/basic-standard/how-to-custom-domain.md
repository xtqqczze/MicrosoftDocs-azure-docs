...
> [!NOTE]
> Azure Spring Apps is going to replace the above IP addresses **in Public cloud** with new IP addresses tagged with `SystemServiceAzureSpringAppsResourceProvider`, for security complaince. To avoid service disruption, please add the service tag in your firewall as soon as possible.
