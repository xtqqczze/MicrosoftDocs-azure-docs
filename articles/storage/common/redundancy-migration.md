...
> [!NOTE]
> For storage accounts leveraging smart tier Public Preview, redundancy conversions and account failover scenarios have additional dependencies. These details are covered in [Optimize costs with smart tier](../blobs/access-tiers-smart.md)
