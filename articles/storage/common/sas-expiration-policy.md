...
>
> Azure File Sync requires a minimum SAS expiry interval of 3 days when NACL is enabled. Configuring the “Upper limit for SAS expiry interval” to less than 3 days prevents the File Sync agent from renewing its SAS token,
