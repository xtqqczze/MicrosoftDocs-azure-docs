...
>
> Azure File Sync requires a minimum SAS expiry interval of 24 hours when NACL is enabled.
> Configuring the “Upper limit for SAS expiry interval” to less than 24 hours prevents the File Sync agent from renewing its SAS token, which will interrupt sync and cloud > recall operations.
> Set the upper limit to ***24 hours***.
