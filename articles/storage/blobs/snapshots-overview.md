...
For storage accounts leveraging smart tier Public Preview, Versions and Snapshots are billed at full content length. See [Optimize costs with smart tier](access-tiers-smart.md) for details.
