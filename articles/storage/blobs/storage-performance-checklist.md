...
>
> - **Use an efficient object naming convention** - Improve load balancing by adding a hash sequence (three digits) or seconds value at the beginning of partition keys. This reduces time for listing, querying, and reading blobs. See [Partitioning](/azure/storage/blobs/storage-performance-checklist#partitioning).  
>
