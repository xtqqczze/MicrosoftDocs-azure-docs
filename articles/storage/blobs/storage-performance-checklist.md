...
> [!div class="checklist"]
>
> - **Review scale limits** - things such as transaction, blob rate etc. (**[Learn more](#section-link)**).
>
> - **Account type** - Consider premium accounts if clients near the transaction rate or request for blob scale limit. (**[Learn more](#section-link)**).
>
> - **Blob naming convention** - Enhance load balancing by using an efficient blob naming convention. (**[Learn more](#section-link)**).
>
> - **Data location** - Locate data and clients close to one another. (**[Learn more](#section-link)**).
>
> - **Content delivery** - Use CDN and Front door to broadcast data. (**[Learn more](#section-link)**).
>
> - **Block size** - Blurb (**[Learn more](#section-link)**).
>
> - **Network bandwidth** - Blurb (**[Learn more](#section-link)**).
>
> - **Network link quality** - Blurb (**[Learn more](#section-link)**).
>
> - **Data transfer tools** - Blurb (**[Learn more](#section-link)**).
> 
> - **Performance monitoring** - Monitor your performance. (**[Learn more](#section-link)**).
>

## Review scale limits

Something here about scale limits relevant to latency and throughput.

Link to scale limit articles as below.
...
If your client hits the transaction target, consider using block blob storage accounts, which are optimized for high transaction rates and low and consistent latency. If you have multiple clients that need to read the same blob and you might exceed the number of requests that single blob can receive per second, then consider using a block blob storage account.   
...
If the blob can be distributed through a CDN such as images or videos served from a website, then you can use a CDN. For more information about Azure CDN, see [Azure CDN overview](../../cdn/cdn-overview.md).
