...
Creating or deleting a time-based retention policy or legal hold on a blob version results in a write transaction charge. Modifying a time-based retention policy (either locking it or extending it) results in an other operation charge. If you are interested in learning more about transaction charges, please see [Operations and Data Transfer](https://azure.microsoft.com/en-us/pricing/details/storage/blobs/#pricing) here.
