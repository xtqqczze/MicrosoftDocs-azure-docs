...
1. Sign in to the [Azure portal](https://portal.azure.com). Search for and select **Machines-Azure Arc**.
   ...
   :::image type="content" source="articles\azure-change-tracking-inventory\media\create-data-collection-rule\select-arc-machines-portal.png" alt-text="Screenshot showing how to select Azure Arc machines from the portal." lightbox="articles\azure-change-tracking-inventory\media\create-data-collection-rule\select-arc-machines-portal.png":::
