...
> [!TIP]
> You must enable resource sync rules on the Azure IoT Operations instance to use the automatic asset discovery capabilities of the Akri services. To learn more, see [What is OPC UA asset discovery?](../discover-manage-assets/overview-akri.md).
