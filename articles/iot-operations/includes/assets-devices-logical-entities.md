...
- A *namespace asset* is a configuration resource that encapsulates information about the data that a physical asset or device exchanges with IoT Operations.
