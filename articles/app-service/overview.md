...
- **Free access**: In addition to the widely available [free tier](https://azure.microsoft.com/en-us/pricing/purchase-options/azure-account), students can take advantage of the [Azure for Students Starter](https://azure.microsoft.com/pricing/offers/ms-azr-0144p) program.
