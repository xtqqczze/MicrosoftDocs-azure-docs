...
|Availability zone pricing|[Two-instance minimum enforced per App Service plan that has Availability Zones enabled](overview.md#pricing). You can have of mix of zone redundant and non-zone redundant App Service plans in the same App Service Environment v3. |[Two-instance minimum enforced per App Service plan](../../reliability/reliability-app-service.md#cost)|
