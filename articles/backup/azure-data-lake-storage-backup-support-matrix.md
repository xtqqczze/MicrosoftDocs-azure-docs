...
- Vaulted Backup does not support moving data across containers (cross-container rename), as backup policies are container-scoped and such moves break replication consistency.
