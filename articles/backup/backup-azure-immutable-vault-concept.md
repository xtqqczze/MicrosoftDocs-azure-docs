...
- Use of WORM storage for immutable vaults in locked state is currently in public preview for Backup Vaults in the following regions: South Africa West, Korea Central, India South, India West, Poland Central.
...
- Use of WORM storage for immutable vaults in locked state is applicable for the following workloads: Azure Virtual machines, SQL in Azure VM, SAP HANA in Azure VM, Azure Files, Azure Backup Server, Azure Backup Agent, DPM, Azure Kubernetes, Postgres Flex Server.
