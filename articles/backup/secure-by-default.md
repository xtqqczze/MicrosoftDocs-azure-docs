...
- **Re-configuration of soft deleted backup items**: You can configure backup for the items in soft deleted state with another vault of your choice.[Learn more.]()
