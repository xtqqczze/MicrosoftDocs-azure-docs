...
Starting March 2026, Azure API Management will apply updated limits to instances in the Classic tiers. [!INCLUDE [api-management-service-limits-mitigation](api-management-service-limits-mitigation.md)]
