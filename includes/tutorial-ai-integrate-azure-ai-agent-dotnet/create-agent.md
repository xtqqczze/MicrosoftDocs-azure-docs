...
> [!NOTE] These steps use the new Foundry portal.
...
1. Give your agent a name and select **Create**. When the agent is ready, you should see the agent playground.
    ...
    Note the [models you can use and the available regions](/azure/ai-foundry/agents/concepts/model-region-support?view=foundry&tabs=global-standard). 
